...
![alt text](assets/dependency_check_res.png)
...
1. **Launch Monitoring Server**
   ![alt text](assets/monitoring_server.png)
...
System metricts are ingested by Prometheus and gathered by Node_exporter and visualized in Grafana dashboard:
![alt text](assets/system_metrics.png)
